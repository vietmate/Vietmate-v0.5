...
const Story: React.FC = () => {
  return (
    <section className="stage bg-[#fdfdfd] texture-overlay flex flex-col justify-center" id="about">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full py-16">
        <div className="flex flex-col md:flex-row items-center gap-12 lg:gap-20">
          <div className="md:w-1/2">
            <span className="text-brand-red font-black uppercase tracking-[0.4em] text-[10px] mb-4 block">Stage 4: Who We Are</span>
            <h2 className="font-display text-4xl md:text-6xl font-black mb-8 leading-[1.1] uppercase tracking-tighter text-charcoal">
              Local Roots,<br />
              <span className="text-brand-red">Global Perspective</span>
            </h2>
            <div className="space-y-6 text-muted-gray leading-relaxed text-base font-bold">
              <p>
                Miles is an Australian-born Vietnamese and Tam being the other is a true Hanoian. Together, we bring over 12 years of experience designing travel in Vietnam. English-speaking and locally based, we create journeys we would confidently recommend to friends and family, balancing authentic experiences with comfort, clarity, and careful planning from start to finish.
              </p>
            </div>
            <div className="mt-10 grid grid-cols-2 gap-4">
              <div className="p-6 bg-white rounded-2xl shadow-lg border border-slate-100">
                <p className="font-black text-[9px] tracking-[0.3em] text-brand-red uppercase mb-1">Location 📍</p>
                <p className="font-black text-sm uppercase tracking-tight text-charcoal">BASED IN VIETNAM</p>
              </div>
              <div className="p-6 bg-white rounded-2xl shadow-lg border border-slate-100">
                <p className="font-black text-[9px] tracking-[0.3em] text-brand-red uppercase mb-1">Philosophy ❤️</p>
        ...
        <div className="mt-12 flex justify-center md:justify-start gap-4">
          <a className="bg-slate-100 text-charcoal px-8 py-4 rounded-full font-black text-xs uppercase tracking-[0.2em] transition-all hover:bg-slate-200" href="#regions">
            Back
          </a>
          <a className="bg-charcoal text-white px-10 py-4 rounded-full font-black text-xs uppercase tracking-[0.2em] shadow-xl hover:bg-brand-red transition-all" href="#stories">
            See Stories ➔
          </a>
        </div>
      </div>

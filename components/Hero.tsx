...
const Hero: React.FC = () => {
  return (
    <header className="stage bg-[#F9F9F9] flex flex-col justify-center" id="hero">
      <div className="relative z-10 text-center px-4 max-w-7xl mx-auto pt-20">
        <div className="inline-flex items-center gap-2 bg-slate-200/50 border border-slate-300/50 px-5 py-2 rounded-full text-charcoal text-[10px] uppercase tracking-[0.3em] font-bold mb-10 shadow-sm">
          <span className="w-2 h-2 rounded-full bg-brand-red animate-pulse"></span> Authentic Local Travel Partner
        </div>
        <h1 className="font-display text-5xl md:text-8xl lg:text-9xl text-charcoal font-extrabold mb-8 tracking-tighter uppercase leading-none flex flex-wrap justify-center items-center">
          <span className="flex items-center">
            ...
            <span className="flex items-center justify-center ml-4 md:ml-6 lg:ml-8 leading-none">
              <svg className="h-[0.72em] w-auto aspect-[3/2] block rounded bg-white shadow-lg" viewBox="0 0 900 600" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
          <a className="bg-brand-red text-white px-12 py-5 rounded-full font-black text-sm uppercase tracking-widest hover:scale-110 transition-all shadow-2xl shadow-red-600/40" href="#why">
            Begin Exploration ➔
          </a>
          <a className="bg-charcoal text-white px-12 py-5 rounded-full font-black text-sm uppercase tracking-widest border border-charcoal transition-all hover:bg-charcoal/90" href="#regions">
            Explore Tours ✨
          </a>
        </div>
      ...
      <a className="absolute bottom-10 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2 text-charcoal/40" href="#why">
        <span className="text-[10px] font-black tracking-widest uppercase">Discover Why</span>
